            ...
            <div className='flex items-center justify-center gap-5 mt-15'>
                <div className='flex items-center justify-center gap-5'>
                    ...
                    <div className="relative">
                        <img
                            className='w-[648px] h-[510px] object-cover rounded-xl'
                            src={featured[11].image}
                            alt={featured[11].name}
                        />
                        {/* card details 1 */}
                        <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-30 z-20 bg-white rounded-xl w-[583px] h-[200px] shadow-xl p-6">
                            ...
                            <p className="text-gray-500 text-base mb-4 leading-relaxed">
                                Spacious 3BHK apartment in a prime location with <br /> modern amenities.
                            </p>
                            ...
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <button className="bg-blue-900 text-white font-semibold px-5 py-2 rounded-full hover:bg-blue-700 transition">
                                    Know More
                                </button>
                            </div>
